...
import { mockCardsByCategory } from "./data";
    ...
    () => ({
      events:
        displayEvents.length > 0
          ...
          : mockCardsByCategory.events.length,
      attractions: mockCardsByCategory.attractions.length,
      restaurants: mockCardsByCategory.restaurants.length,
      bars: mockCardsByCategory.bars.length,
      thingsToDo: mockCardsByCategory.thingsToDo.length,
    }),
    [displayEvents]
  );
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Kies een categorie om andere picks te bekijken.
                </p>
              </div>
