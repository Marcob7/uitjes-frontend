...
export default function PlansFallenThroughSection({
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#edf5ee] px-5 py-[clamp(4.5rem,10vw,8.5rem)] text-[#183328] sm:px-8 lg:px-12">
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-14 lg:grid-cols-[minmax(0,0.92fr)_minmax(24rem,0.8fr)] lg:gap-20">
        <div className="relative z-10 max-w-xl">
          <motion.p
            ...
            className="inline-flex rounded-full border border-[#6b9479]/30 bg-[#f7fbf5]/70 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-[#376047] shadow-[0_8px_24px_rgba(44,83,57,0.08)] backdrop-blur-sm"
          >
            Plannen gewijzigd?
          </motion.p>
