...
export function CalendarNewsletterSignupSection() {
        ...
        <div className="relative grid gap-8 lg:grid-cols-[minmax(0,0.92fr)_minmax(22rem,1fr)] lg:items-end lg:gap-12">
          <div className="max-w-[38rem]">
            ...
            <p className="mt-5 max-w-[35rem] text-sm leading-7 text-white/76 sm:text-base sm:leading-8">
              Ontvang updates wanneer er nieuwe evenementen aan de
              jaarkalender worden toegevoegd. Handig als je vooruit wilt
              plannen of niets leuks in jouw omgeving wilt missen.
            </p>

            <div className="mt-6 flex flex-wrap gap-2">
              {["Nieuwe kalenderitems", "Vooruit plannen", "Regio optioneel"].map(
                (label) => (
                  <span
                    key={label}
          ...
          <form
            ...
            aria-label="Aanmelden voor jaarkalender updates"
          >
            <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(0,0.78fr)]">
              <label className="grid gap-2 text-sm font-semibold text-white">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  aria-describedby={message ? "calendar-newsletter-message" : undefined}
            ...
            {message ? (
              <p
                id="calendar-newsletter-message"
                role="status"
                aria-live="polite"
