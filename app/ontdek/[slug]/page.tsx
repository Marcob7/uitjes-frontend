...
export default async function ExploreDetailPage({ params, searchParams }: PageProps) {
  ...
  return <main className="min-h-screen bg-[#fbfaf6] text-[#203329]"><div className="mx-auto max-w-[1420px] px-4 pb-20 pt-[calc(var(--mobile-flow-top-offset)+0.625rem)] sm:px-6 lg:px-10 lg:pb-28 lg:pt-8 lg:mt-28">
