...
function UsersIcon() { return <svg className="h-5 w-5" viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="7" cy="7" r="2.5" stroke="currentColor" strokeWidth="1.35" /><path d="M2.75 16c.45-2.55 2.1-4 4.25-4s3.8 1.45 4.25 4M13.5 5.25a2.25 2.25 0 1 1 0 4.5M13.5 12c1.95 0 3.25 1.25 3.75 3.25" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" /></svg>; }
function CompassIcon() { return <svg className="h-5 w-5" viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="6.75" stroke="currentColor" strokeWidth="1.35" /><path d="m12.75 7.25-1.5 3.5-3.5 1.5 1.5-3.5 3.5-1.5Z" stroke="currentColor" strokeWidth="1.35" strokeLinejoin="round" /></svg>; }
function CalendarIcon() { return <svg className="h-5 w-5" viewBox="0 0 20 20" fill="none" aria-hidden="true"><rect x="3.25" y="4.75" width="13.5" height="11.5" rx="2" stroke="currentColor" strokeWidth="1.35" /><path d="M6.5 3v3.5M13.5 3v3.5M3.25 8h13.5" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" /></svg>; }
function SunIcon() { return <svg className="h-5 w-5" viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="3" stroke="currentColor" strokeWidth="1.35" /><path d="M10 2.5v1.25M10 16.25v1.25M17.5 10h-1.25M3.75 10H2.5M15.3 4.7l-.9.9M5.6 14.4l-.9.9M15.3 15.3l-.9-.9M5.6 5.6l-.9-.9" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" /></svg>; }
function ReasonIcon({ reason }: { reason: string }) {
  const text = reason.toLocaleLowerCase("nl-NL");
  if (/(vriend|samen|solo|kind|famil|gezelschap)/.test(text)) return <UsersIcon />;
  if (/(locatie|ligging|centraal|route|loopafstand|stad)/.test(text)) return <PinIcon />;
  if (/(moment|avond|middag|ochtend|weekend|vandaag|plann|reserver|voorbereid|flexibel)/.test(text)) return <CalendarIcon />;
  if (/(natuur|buiten|weer|actief|ruimte)/.test(text)) return <SunIcon />;
